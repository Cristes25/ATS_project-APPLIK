...
export default function ProgramarEntrevistaModal({ candidato, onClose }) {
  return (
      ...
      <div className="w-full sm:max-w-md bg-white rounded-t-3xl sm:rounded-2xl shadow-xl">
        ...
        <div className="px-6 pt-6 pb-4 border-b border-slate-100 flex items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="flex size-10 items-center justify-center rounded-xl bg-teal-dark/10">
              <Calendar className="size-5 text-teal-dark" />
            </div>
            <div>
        ...
        <div className="px-6 py-5 space-y-5">
          ...
          <div className="rounded-xl border border-amber-200 bg-amber-50 p-4">
            <p className="text-sm font-semibold text-amber-800 mb-2 flex items-center gap-1.5">
              <Sparkles className="size-3.5" /> Programación de entrevistas en preparación
            </p>
            <p className="text-xs text-amber-700 leading-relaxed mb-3">
              Estamos construyendo el módulo de calendarización. Cuando esté activo, podrás programar entrevistas y se enviará un correo automático al candidato con los detalles.
            </p>
            <p className="text-xs font-semibold text-amber-800 mb-1.5">Próximamente:</p>
            <ul className="text-xs text-amber-700 space-y-1 list-disc list-inside">
              <li>Entrevistas presenciales, virtuales y telefónicas</li>
              <li>Notificación automática al candidato por correo</li>
              <li>Recordatorio cercano a la fecha programada</li>
              <li>Notas privadas para el reclutador</li>
            </ul>
          </div>
